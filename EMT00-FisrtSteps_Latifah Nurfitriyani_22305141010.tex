...
\end{eulercomment}
\eulerimg{24}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-004.png}
\eulerimg{13}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-005.png}
\eulersubheading{}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-010.png}
\begin{eulerprompt}
> $& solve(a * x^2 + b * x + c, x) // rumus abc
\end{eulerprompt}
\begin{eulerformula}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-013.png}
\begin{eulercomment}
\begin{eulercomment}
\eulerheading{Latihan Tambahan}
\begin{eulerprompt}
> r = 2.5; pi*r^2, 2*pi*r
\end{eulerprompt}
\begin{euleroutput}
...
> plot3d("x^3+y^3+6"):
\end{eulerprompt}
\eulerimg{24}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-014.png}
\begin{eulerprompt}
> plot3d("exp(-(x^2+y^3)/5)",r=10,n=80,fscale=4,scale=1.2,frame=3):
\end{eulerprompt}
\eulerimg{24}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-015.png}
\begin{eulerprompt}
> plot3d("x^2+y^7",>spectral,>contour,n=10):
\end{eulerprompt}
\eulerimg{24}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-016.png}
\begin{eulerprompt}
> plot3d("x^2/(x^2+y^2+1)",color=0,>hue,grid=10):
\end{eulerprompt}
\eulerimg{24}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-017.png}
\begin{eulerprompt}
> t=linspace(9,2pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=yellow):
\end{eulerprompt}
\eulerimg{24}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-018.png}
\begin{eulerprompt}
...
> plot2d(expr,-1,1):
\end{eulerprompt}
\eulerimg{24}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-019.png}
\begin{eulerprompt}
> expr &= x^2 - x + 5
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerprompt}
\eulerimg{24}{images/EMT00-FisrtSteps_Latifah Nurfitriyani_22305141010-020.png}
